...
void main(void) {
    if (gl_InvocationID == 0) {
        ...
        vec4 ViewSpacePos00 = camera.view * gl_in[0].gl_Position;
        vec4 ViewSpacePos01 = camera.view * gl_in[1].gl_Position;
        vec4 ViewSpacePos10 = camera.view * gl_in[2].gl_Position;
        vec4 ViewSpacePos11 = camera.view * gl_in[3].gl_Position;
